...
class Zarinpal_WebGate_ProcessingController extends Mage_Core_Controller_Front_Action
{
    ...
    public function redirectAction()
    {
        try {
            ...
            if ($order->getState() != Mage_Sales_Model_Order::STATE_PENDING_PAYMENT) {
                $order->setState(Mage_Sales_Model_Order::STATE_PENDING_PAYMENT, $this->_getPendingPaymentStatus(), Mage::helper('WebGate')->__('Customer was redirected to WebGate gateway.'))->save();
            }
    ...
    public function cabsuccessAction()
    {
        try {
            ...
            $client = new SoapClient('http://Acquirer.sb24.com/ref-payment/ws/ReferencePayment?WSDL', array(
                'exceptions' => 0
            ));
